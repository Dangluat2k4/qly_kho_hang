...
public class dbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE BillDetail(id integer PRIMARY KEY AUTOINCREMENT,billID integer REFERENCES Bill(id),quantity text REFERENCES Bill(quantity),createdDate text REFERENCES Bill(createdDate))");
        ...
        db.execSQL("insert into BillDetail values (1,'1','10','2023-10-18 11:15:00'),(2,'2','15','2023-10-18 11:30:00')");
        // them du lieu mau
    }
    @Override
